...
If the requirement can be automatically evaluated, add an evaluation method to [the evaluation module](./src/charmhub_listing_review/evaluate.py). AI-powered features are available to provide additional guidance beyond pass/fail checks — see the [AI roadmap](./AI_ROADMAP.md) for details.
